...
# will prompt the bot to reply with an animated emoji of that emoticon. The emojis behind this are stored in the bot's
# "home server".
module Emoticons
  ...
  message start_with: '(', end_with: ')' do |event|
    ...
    event.message.reply!(emoji.mention) if emoji
  end
